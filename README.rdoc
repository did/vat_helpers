...
Use this plugin to validate VAT numbers for european countries as well as get the tax rate depending on the country of the buyer.
...
Let's review the different cases for a seller in France:
  ...
  1. the seller in outside Europe
